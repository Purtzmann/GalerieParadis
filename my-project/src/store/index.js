...
export default new Vuex.Store({
   state: {
      ...
      GalerieBMerci:[
        ...
        { id: 3, titre: "Message en vie", price: "Vendu", img: require('../assets/GalerieBMerci/Message-en-vie.jpg'), dimension: '100 x 81cm', peinture:'Peinture à l\'huile', artiste: "T'M"},
        { id: 4, titre: "Voilier en admiration", price: "Vendu", img: require('../assets/GalerieBMerci/Message-en-vie.jpg'), dimension: '100 x 73cm', peinture:'Peinture Acrylique', artiste: "T'M"},
        { id: 5, titre: "Sérénité de fin du jour", price: "Vendu", img: require('../assets/GalerieBMerci/Sérénité-de-fin-du-jour.jpg'), dimension: '61 x 46cm', peinture:'Peinture à l\'huile', artiste: "T'M"},
        { id: 6, titre: "Soins en Art", price: "1500", img: require('../assets/GalerieBMerci/Soins-en-Art.jpg'), dimension: '116 x 89cm', peinture:'Peinture à l\'huile', artiste: "T'M"},
        ...
        { id: 8, titre: "Carrelets de plénitude", price: "500", img: require('../assets/GalerieBMerci/Carrelets-de-plénitude.jpg'), dimension: '90 x 30cm', peinture:'Peinture Acrylique', artiste: "T'M"},
